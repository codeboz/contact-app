...
namespace CBZ.ContactApp.Data.Configuration
{
    public class InfoEntityTypeConfiguration:IEntityTypeConfiguration<Info>
    {
        ...
        public  static IEnumerable<Info> InfoSeed =>
            new List<Info>
            {
                //new Contact{Company = "A",Id = Guid.Parse("3999bbc4-751e-4fe5-9e72-4c6e88f6cff4"),Name = "A",Surname = "Aa"},
                new Info{ContactId = Guid.Parse("3999bbc4-751e-4fe5-9e72-4c6e88f6cff4"), InfoTypeId = 1, Data = "11111111"},
                new Info{ContactId = Guid.Parse("3999bbc4-751e-4fe5-9e72-4c6e88f6cff4"), InfoTypeId = 2, Data = "a@a.com"},
                new Info{ContactId = Guid.Parse("3999bbc4-751e-4fe5-9e72-4c6e88f6cff4"), InfoTypeId = 3, Data = "Ankara"},
                                                                                                     
                //new Contact{Company = "B",Id = Guid.Parse("3182b605-a8cb-4eb4-81fb-81129159f095"),Name = "B",Surname = "Bb"},
                new Info{ContactId = Guid.Parse("3182b605-a8cb-4eb4-81fb-81129159f095"), InfoTypeId = 1, Data = "222222222"},
                new Info{ContactId = Guid.Parse("3182b605-a8cb-4eb4-81fb-81129159f095"), InfoTypeId = 2, Data = "b@b.com"},
                new Info{ContactId = Guid.Parse("3182b605-a8cb-4eb4-81fb-81129159f095"), InfoTypeId = 3, Data = "Ankara"},
                                                                                                     
                //new Contact{Company = "C",Id = Guid.Parse("b75cdf77-243b-4eb8-ab08-c44dcddb70ef"),Name = "C",Surname = "Cc"},
                new Info{ContactId = Guid.Parse("b75cdf77-243b-4eb8-ab08-c44dcddb70ef"), InfoTypeId = 1, Data = "333333333"},
                new Info{ContactId = Guid.Parse("b75cdf77-243b-4eb8-ab08-c44dcddb70ef"), InfoTypeId = 2, Data = "c@c.com"},
                new Info{ContactId = Guid.Parse("b75cdf77-243b-4eb8-ab08-c44dcddb70ef"), InfoTypeId = 3, Data = "Ankara"},
