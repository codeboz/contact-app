...
namespace CBZ.ContactApp.Data.Configuration
{
    public class ReportRequestEntityTypeConfiguration:IEntityTypeConfiguration<ReportRequest>
    {
        public static IEnumerable<ReportRequest> ReportRequestSeed =>
            ...
            {
                new ReportRequest{Id = Guid.Parse("bf5bd4b9-ebf5-41a8-a597-69b7aeb41432"), Location = "Ankara",ReportStateId = 1},
                new ReportRequest{Id = Guid.Parse("4c802ae2-5292-4063-b5ca-e09b18871143"), Location = "Bursa",ReportStateId = 2},
            };
